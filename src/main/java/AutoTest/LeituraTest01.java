...
public class LeituraTest01 {
    ...
    public void setCellCadastro(TratamentoTest01 tratamento, PlanilhaTest01 planilha, Sheet sheet, int i) {
    ...
    public void setCellMensagem(TratamentoTest01 tratamento, Sheet sheet, int i){
        Row row = sheet.getRow(i);
        if (row == null) return;
    ...
    public boolean checkCadastro(TratamentoTest01 tratamento, PlanilhaTest01 planilha, Sheet sheet, DataFormatter formatter, int i){
        Row row = sheet.getRow(i);
    ...
    public void valorSteers(AutomacaoTest01 automacao, WebDriver driver, TratamentoTest01 tratamento) {
        try (FileInputStream fis = new FileInputStream(filePath())){
             Workbook workbook = new XSSFWorkbook(fis);
            ...
            PlanilhaTest01 planilha = new PlanilhaTest01();
